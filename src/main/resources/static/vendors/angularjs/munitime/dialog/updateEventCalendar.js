...
function UpdateEventCalendarController($scope, $mdDialog,$route,items,$http,User,mdcDateTimeDialog) {
				 ...
				 if(User.getAdmin() && (User.getEmail() != items.user.username)){
				  ...
				  console.log("Heure debut " + items.heureDebut);
				  
				  $scope.heureDebut =moment(items.dateDebut,"DD/MM/YYYY HH:mm:ss").toDate();
				  ...
				  $scope.heureFin =moment(items.dateFin,"DD/MM/YYYY HH:mm:ss").toDate();
				  
				  $scope.dateFin = moment( items.dateFin,"DD/MM/YYYY HH:mm:ss").format("DD/MM/YYYY HH:mm:ss");
