...
app.controller("interventionGroupe",function($scope,$http,$route,User,$window,$mdDialog,$mdMedia,$filter){
  ...
  $scope.admin=false;
  	...
  	$scope.home = function(){
  		...
  		$scope.updateFilteredList = function() {
		    $scope.filteredList = $filter("filter")($scope.activitesEmployes, $scope.query3);
	};
		  ...
		  $http({
		      ...
		      url: url1
			   ...
			   $scope.activitesEmployes = success.data;
				  ...
				  for(var i=0; i<$scope.activitesEmployes.length ;i++){
				  ...
				  $scope.filteredList = $scope.activitesEmployes;
